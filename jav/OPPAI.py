...
class OPPAI(object):
    def __init__(self, video_no):
        ...
        # 搜索列表
        list_url = 'https://oppai-av.com/search/list?keyword={video_no}'.format(video_no=video_no.replace('-', ''))
...
if __name__ == '__main__':
    ...
    print(oppai.get_fanart_url())
    print(oppai.get_movie_url())

    print(oppai.get_poster_ext())
    print(oppai.get_fanart_ext())
    print(oppai.get_movie_ext())
