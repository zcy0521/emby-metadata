...
class IdeaPocket(object):
    def __init__(self, video_no):
        ...
        # 搜索列表
        list_url = 'https://ideapocket.com/search/list?keyword={video_no}'.format(
        ...
        # 详情页
        self.detail_url = list_soup.find('div', class_="swiper-wrapper").find('div', class_="item").find('a')['href']
...
if __name__ == '__main__':
    ...
    print(idea_pocket.get_fanart_url())
    print(idea_pocket.get_movie_url())

    print(idea_pocket.get_poster_ext())
    print(idea_pocket.get_fanart_ext())
    print(idea_pocket.get_movie_ext())
