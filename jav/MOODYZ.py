...
class MOODYZ(object):
    def __init__(self, video_no):
        ...
        # 搜索列表
        list_url = 'https://moodyz.com/search/list?keyword={video_no}'.format(video_no=video_no.replace('-', ''))
...
if __name__ == '__main__':
    ...
    print(moodyz.get_fanart_url())
    print(moodyz.get_movie_url())

    print(moodyz.get_poster_ext())
    print(moodyz.get_fanart_ext())
    print(moodyz.get_movie_ext())
