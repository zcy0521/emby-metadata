...
class Das(object):
    def __init__(self, video_no):
        ...
        # 搜索列表
        list_url = 'https://dasdas.jp/search/list?keyword={video_no}'.format(video_no=video_no.lower().replace('-', ''))
...
if __name__ == '__main__':
    ...
    print(das.get_fanart_url())
    print(das.get_movie_url())

    print(das.get_poster_ext())
    print(das.get_fanart_ext())
    print(das.get_movie_ext())
