...
class EBODY(object):
    def __init__(self, video_no):
        ...
        # 搜索列表
        list_url = 'https://av-e-body.com/search/list?keyword={video_no}'.format(video_no=video_no.replace('-', ''))
...
if __name__ == '__main__':
    ...
    print(ebody.get_fanart_url())
    print(ebody.get_movie_url())

    print(ebody.get_poster_ext())
    print(ebody.get_fanart_ext())
    print(ebody.get_movie_ext())
