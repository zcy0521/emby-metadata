...
class BeFree(object):
    ...
    SEARCH_URL = 'https://befreebe.com/search/list?keyword={video_no}'

    def __init__(self, video_no):
        self.video_no = video_no

        # 搜索列表
        list_url = BeFree.SEARCH_URL.format(video_no=video_no.replace('-', ''))
...
if __name__ == '__main__':
    # https://befreebe.com/search/list?keyword=BF549
    befree = BeFree('BF-549')
    # print(befree.get_poster_url())
    # print(befree.get_backdrop_url())
    # print(befree.get_trailer_url())

    befree.create_nfo('D:\\JetBrains\\PycharmProjects\\emby-metadata\\nfo')
