...
class BeFree(object):
    def __init__(self, video_no):
        ...
        # 搜索列表
        list_url = 'https://befreebe.com/search/list?keyword={video_no}'.format(video_no=video_no.replace('-', ''))
...
if __name__ == '__main__':
    ...
    print(befree.get_fanart_url())
    print(befree.get_movie_url())

    print(befree.get_poster_ext())
    print(befree.get_fanart_ext())
    print(befree.get_movie_ext())
