...
class Muku(object):
    ...
    SEARCH_URL = 'https://muku.tv/search/list?keyword={video_no}'

    def __init__(self, video_no):
        self.video_no = video_no

        # 搜索列表
        list_url = Muku.SEARCH_URL.format(video_no=video_no.replace('-', ''))
...
if __name__ == '__main__':
    ...
    print(muku.get_backdrop_url())
    print(muku.get_trailer_url())
