...
class Muku(object):
    def __init__(self, video_no):
        ...
        # 搜索列表
        list_url = 'https://muku.tv/search/list?keyword={video_no}'.format(video_no=video_no.replace('-', ''))
...
if __name__ == '__main__':
    # https://muku.tv/search/list?keyword=MUDR180
    muku = Muku('MUDR-180')

    print(muku.get_poster_url())
    print(muku.get_fanart_url())
    print(muku.get_movie_url())

    print(muku.get_poster_ext())
    print(muku.get_fanart_ext())
    print(muku.get_movie_ext())
