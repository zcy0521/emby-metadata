...
class Mvg(object):
    def __init__(self, video_no):
        ...
        # 搜索列表
        list_url = 'https://mvg.jp/search/list?keyword={video_no}'.format(video_no=video_no.replace('-', ''))
...
if __name__ == '__main__':
    # https://mvg.jp/search/list?keyword=MVSD481
    mvg = Mvg('MVSD-481')

    print(mvg.get_poster_url())
    print(mvg.get_fanart_url())
    print(mvg.get_movie_url())

    print(mvg.get_poster_ext())
    print(mvg.get_fanart_ext())
    print(mvg.get_movie_ext())
