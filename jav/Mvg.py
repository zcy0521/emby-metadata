...
class Mvg(object):
    ...
    SEARCH_URL = 'https://mvg.jp/search/list?keyword={video_no}'

    def __init__(self, video_no):
        self.video_no = video_no

        # 搜索列表
        list_url = Mvg.SEARCH_URL.format(video_no=video_no.replace('-', ''))
...
if __name__ == '__main__':
    ...
    print(mvg.get_backdrop_url())
    print(mvg.get_trailer_url())
